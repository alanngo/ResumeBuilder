...
def main():
    ...
    for i in range(0, 4):
        ...
        doc.list_skill(category,
                       ...
                       x_left=SUB_HEADER_POS, x_right=max(word_len) + 120, y=650 - (15 * i))
    ...
    for i in range(3):
        ...
        doc.list_exp(company, job_title, location, date,
                     x_left=SUB_HEADER_POS, x_right=LOC_POS, y=550 - (75 * i),  # 75 apart
    ...
    for i in range(3):
        ...
        doc.list_project(name, x=SUB_HEADER_POS, y=300 - 75 * i, bullets=generate_list(name))
